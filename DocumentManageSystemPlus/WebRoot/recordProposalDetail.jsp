...
<html>
  <head>
    ...
    <title>My JSP 'recordProposalDetail.jsp' starting page</title>
  ...
  <body>
    <jsp:useBean  id="user" class="entity.user" scope="session"/>
  	...
  	<div class="content-left" style="height: 850px">
  		<h2 align="center"><font color="#FF9900">查看该提案的详细信息以确认是否备案</font></h2>
  	</div>
  	<div class="content-right" style="height: 850px">
	    ...
	    <%
	     ...
	     <%
  		...
  		<hr>
  		<p>如果您不愿意将此提案备案,请<a href="recordProposal.jsp">点击此处</a>回到选择备案页面</p>
  		<hr>
  		<p>如果您希望将此提案备案，请填写备案的标题和内容.其中系统已经<strong>默认</strong>为您生成备案的标题.如果您对此标题不满意，可以自行更改</p>
  		<form action="servlet/recordProposalOperation" method="post">
  			<input type="hidden" readonly="readonly" name="recordProposalId" value=<%=p.getProposalId() %>>
  			<table>
  				<tr>
  					<td>备案标题</td>
  					<td>
  						<%String defaultTitle = p.getTitle() + "的备案"; %>
  						<input type="text" name="recordTitle" value=<%=defaultTitle %>>
  					</td>
  				</tr>
  				<tr>
  					<td>备案内容</td>
  					<td>
  						<textarea name="recordContent" rows="10" cols="40"></textarea>
  					</td>
  				</tr>
  				<tr>
  					<td colspan="2"><input type="submit" value="上报备案" /></td>
  				</tr>
  			</table>
  		</form>
  	</div>
